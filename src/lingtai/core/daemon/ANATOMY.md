...
daemon/__init__.py
  ...
  ├── _handle_list/check/reclaim    — individual action handlers; list scans active entries plus historical run-dir JSON records and performs best-effort lazy daemon.json rebuilds
