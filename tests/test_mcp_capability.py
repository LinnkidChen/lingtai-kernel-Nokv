...
def test_nokv_workbench_registry_example_is_valid():
    ...
    assert record["template_arg_indices"] == [10]
...
def test_retry_failed_mcps_records_dead_then_recovers(tmp_path, monkeypatch):
    ...
    original_connect_mcp = Agent.connect_mcp

    def recording_connect_mcp(
        self,
        command,
        args=None,
        env=None,
        *,
        template_arg_indices=None,
        _allow_sealed=False,
        _init_spec_name=None,
        _predecessor=None,
    ):
        template_calls.append(template_arg_indices)
        return original_connect_mcp(
            self,
            command,
            args,
            env,
            ...
            _init_spec_name=_init_spec_name,
    ...
    monkeypatch.setattr(Agent, "connect_mcp", recording_connect_mcp)
